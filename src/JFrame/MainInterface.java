...
public class MainInterface {
     ...
     * @author 86183
     */
    public static class MianInterface extends javax.swing.JFrame {

        /**
         * Creates new form MianInterface
         */
        public MianInterface() {
            initComponents();
        }
        ...
        private void boxItemStateChanged(java.awt.event.ItemEvent evt) {
            // TODO add your handling code here:
        }
        ...
        public static void main(String args[]) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(MianInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new MianInterface().setVisible(true);
                }
            });
