...
public class AdminFunc extends javax.swing.JFrame {
    ...
    private void CbuttonActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        Object option = jComboBox2.getSelectedItem();


        if (option=="Help customers register"){
            this.dispose();
            new CoustomerReg().setVisible(true);
        }else if (option=="Help book appliance service appointments"){
            this.dispose();
            new BookingFunc().setVisible(true);
        }else if (option=="View user registration information."){
            this.dispose();
